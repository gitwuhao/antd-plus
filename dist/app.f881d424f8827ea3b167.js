...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	  return function (action) {
	    var factory = function factory(name, data) {
	      if (false) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loopArray(array, handle) {
	  (0, _methods.each)(array, function (index, item) {
	    handle(index, item);
	...
	function setItemId(item) {
	  item.__guid__ = (0, _methods.getGuid)();
	  return item;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dataToMap(data) {
	  var structureMap = {};
	  var rootChildren = [];
	  (0, _methods.each)(data, function (index, firstItem) {
	    (0, _methods.each)(firstItem.children, function (i, subItem) {
	  ...
	  (0, _methods.each)([rootKey].concat(rootChildren), function (i, key) {
	    var array = structureMap[key];
	    (0, _methods.each)(array, function (i, item) {
	      array[item] = i;
	    });
	  });
	  ...
	  _createClass(Tool, [{
	    ...
	    value: function getPanel(item) {
	      ...
	      (item.children || []).map(function (iconItem) {
	        children.push(_react2.default.createElement(_IconItem2.default, _extends({ key: (0, _methods.getGuid)() }, iconItem)));
	      });
	      return _react2.default.createElement(
	        Panel,
	    ...
	    value: function render() {
	      ...
	      (data || []).map(function (item) {
	        var key = item.key || (0, _methods.getGuid)();
	        if (!firstKey) {
	          firstKey = key;
	        }
	        item.key = key;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dragula = __webpack_require__(248);
	
	var _dragula2 = _interopRequireDefault(_dragula);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _dragula2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var crossvent = __webpack_require__(254);
	var classes = __webpack_require__(257);
	var doc = document;
	var documentElement = doc.documentElement;
	
	var debug = __webpack_require__(200);
	var log = debug('dragula');
	...
	function dragula(initialContainers, options) {
	  ...
	  if (o.cloneMirrorImage === void 0) {
	    o.cloneMirrorImage = cloneMirrorImage;
	  }
	
	  // if (o.canStart === void 0) { o.canStart = always; }
	  ...
	  function canStart(item) {
	    ...
	    var handle = item;
	    while (getParent(item) && isContainer(getParent(item)) === false /*&& o.canStart(item,source, handle)===false*/) {
	  ...
	  function cleanup() {
	    ...
	    /*++ direction detect @wuhao ++*/
	    delete o.lastClientX;
	    delete o.lastClientY;
	    /*----------------------*/
	  ...
	  function drag(e) {
	    ...
	    /*++ direction detect @wuhao ++*/
	    if (o.lastClientX) {
	      var isHorizontal = Math.abs(o.lastClientX - clientX) > Math.abs(o.lastClientY - clientY);
	      o.direction = isHorizontal ? 'horizontal' : 'vertical';
	    }
	    o.lastClientX = clientX;
	    o.lastClientY = clientY;
	    /*----------------------*/
	    ...
	    if (reference === null && changed || reference !== item && reference !== nextEl(item)) {
	      ...
	      if (!o.insertBefore) {
	        ...
	        o.insertBefore(item, dropTarget, _source, reference);
	      }
	  ...
	  function renderMirrorImage() {
	    ...
	    _mirror = o.cloneMirrorImage(_item);
	    if (!_mirror) {
	      _mirror = cloneMirrorImage(_item);
	    }
	...
	function cloneMirrorImage(item) {
	  var rect = item.getBoundingClientRect();
	  var cloneItem = item.cloneNode(true);
	  cloneItem.style.width = getRectWidth(rect) + 'px';
	  cloneItem.style.height = getRectHeight(rect) + 'px';
	  classes.rm(cloneItem, 'gu-transit');
	  classes.add(cloneItem, 'gu-mirror');
	  return cloneItem;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var atoa = __webpack_require__(250);
	var debounce = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ticky = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var customEvent = __webpack_require__(255);
	var eventmap = __webpack_require__(256);
	    ...
	    value: function loop(data, parentPath) {
	      ...
	      (data || []).map(function (item, index) {
	        ...
	        children.push(_react2.default.createElement(
	          _Item2.default,
	          _extends({ key: (0, _methods.getGuid)() }, props),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mapStateToProps(state) {
	  ...
	  if ((0, _methods.isFunction)(propertys)) {
	    propertys = propertys();
	  } else {
	    propertys = null;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getField = function getField(field) {
	  ...
	  if (type) {
	    FiledItem = _index2.default[type];
	  } else {
	    FiledItem = _index2.default.string;
	  }
	  ...
	  _createClass(FormPanel, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          ...
	          type = _props.type,
	          propertyFields = _props.propertyFields,
	          propertyValues = _props.propertyValues;
	  ...
	  _createClass(DefaultField, [{
	    ...
	    value: function render() {
	      ...
	      var _props = this.props,
	          ...
	          link = _props.link,
	          label = _props.label,
	          props = _objectWithoutProperties(_props, ['fieldValue', 'layout', 'link', 'label']);
	  ...
	  _createClass(EnumField, [{
	    ...
	    value: function render() {
	      var _props2 = this.props,
	          ...
	          label = _props2.label,
	          data = _props2.data,
	          props = _objectWithoutProperties(_props2, ['fieldValue', 'layout', 'label', 'data']);
	
	      var children = [];
	      (data || []).map(function (v) {
	        children.push(_react2.default.createElement(
	          Option,
	          { value: v, key: (0, _methods.getGuid)() },
	          v
	        ));
	      });
	      return _react2.default.createElement(
...
[880, 320, 317],
/* 455 */
[881, 456, 288, 457, 293, 313, 458, 459, 463, 465, 464],
/* 456 */
/***/ function(module, exports) {
...
655,
/* 459 */
[882, 460, 302, 463, 293, 464],
/* 460 */
[863, 295, 461, 325, 322, 300, 462],
/* 461 */
[864, 294, 295, 311, 298],
/* 462 */
[865, 289],
...
/***/ },
/* 473 */
[837, 289, 313, 298, 288, 457, 474, 299, 323, 463, 324, 464, 470, 475, 476, 477, 478, 295, 314, 301, 302, 460, 479, 481, 294, 311, 480, 327, 326, 456, 293],
/* 474 */
[846, 324, 296, 313, 294, 299],
/* 475 */
[851, 289, 290, 456, 470, 294],
/* 476 */
[852, 311, 314],
/* 477 */
[861, 311, 326, 327],
...
[867, 312, 325],
/* 481 */
[868, 327, 302, 314, 301, 313, 297, 298],
/* 482 */
/***/ function(module, exports) {
	  ...
	  _createClass(JSONField, [{
	    ...
	    value: function render() {
	      var _props2 = this.props,
	          ...
	          layout = _props2.layout,
	          label = _props2.label,
	          props = _objectWithoutProperties(_props2, ['fieldValue', 'layout', 'label']);
